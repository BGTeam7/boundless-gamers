...
const Navbar = () => {
    ...
    return (
        <nav className="navbar py-2 px-10 flex justify-between items-center md:grid md:grid-cols-5 sticky top-0 z-20">
            <Link to='/'>
            ...
            <div className={`w-full h-full md:flex md:items-center md:w-auto 
                ...
                <a href="https://www.paypal.com/donate/?hosted_button_id=RUGEY8J38GKU4&fbclid=IwZXh0bgNhZW0CMTEAAR3zgSZcImCLTqA2kp7k-JkWzn2axuD_yuD6vpf0awLrN42leFUIDYroIhM_aem_DlQq1v5p6fbh7QZeFX5VwA">
                    <button className="border-pink-300 border-2 pinkfill rounded-md py-1 px-4 text-white">DONATE</button>
                </a>
